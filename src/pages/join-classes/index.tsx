...
export const JoinClassesList = () => {
  ...
  return (
    <ListView className='container mx-auto pb-8 px-2 sm:px-4'>
      ...
      <Card className='border-2 border-teal-600/30 bg-gradient-to-br from-teal-50 to-teal-100 shadow-md transition-shadow duration-300 mb-8 relative overflow-hidden'>
